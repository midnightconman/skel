...
if &t_Co >= 256 || has("gui_running")
		hi Normal ctermbg=NONE ctermfg=15 cterm=NONE guibg=#101112 guifg=#FDFEFF gui=NONE
	set background=dark
		hi NonText ctermbg=NONE ctermfg=0 cterm=NONE guibg=NONE guifg=#101112 gui=NONE
		hi Comment ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#BCC0C5 gui=NONE
		...
		hi Search ctermbg=54 ctermfg=0 cterm=NONE guibg=#D8C27A guifg=#101112 gui=NONE
		...
		hi vimCommentString ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#BCC0C5 gui=NONE
