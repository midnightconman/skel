...
ALL_APPS := base-devel xorg-server xorg-apps xorg-xinit vim bc fluxbox xscreensaver docker rxvt-unicode cantarell-fonts compton feh keepassx ttf-dejavu ttf-inconsolata noto-fonts ttf-liberation ttf-droid xorg-xfontsel pidgin tmux jq fakeroot dmenu xsel
