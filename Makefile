...
ALL_APPS := base-devel xorg-server xorg-apps xorg-xinit vim fluxbox xscreensaver docker rxvt-unicode cantarell-fonts compton feh keepassx ttf-dejavu ttf-inconsolata noto-fonts ttf-liberation pidgin tmux jq fakeroot dmenu go
